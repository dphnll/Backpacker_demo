...
const APP_VERSION = "1.1.2.29";
const APP_RELEASE_SUMMARY = "название поездки аккуратно размещается рядом с логотипом, а форма AI-черновика получила более ясную и компактную подсказку.";
