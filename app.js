...
const APP_VERSION = "1.1.2.28";
const APP_RELEASE_SUMMARY = "кнопка «На главную» в поездке стала крупнее и заметнее: логотип теперь выглядит как стеклянная линза и лучше считывается как переход домой.";
