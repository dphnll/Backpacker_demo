...
const APP_VERSION = "1.1.2.27";
const APP_RELEASE_SUMMARY = "раздел с полным списком карточек называется «Все события», а его иконка в нижней навигации стала понятнее.";
